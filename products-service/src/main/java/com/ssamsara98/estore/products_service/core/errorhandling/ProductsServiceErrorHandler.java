...
public class ProductsServiceErrorHandler {
	...
	public ResponseEntity<Object> handleIllegalStateException(IllegalStateException ex, WebRequest request) {
		System.out.println("ProductsServiceErrorHandler--IllegalStateException");
	...
	public ResponseEntity<Object> handleOtherExceptions(Exception ex, WebRequest request) {
		System.out.println("ProductsServiceErrorHandler--Exception");
		ErrorMessage errorMessage = new ErrorMessage(new Date(), ex.getMessage());
		return new ResponseEntity<>(errorMessage, new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR);
	}
	...
	public ResponseEntity<Object> handleCommandExecutionException(CommandExecutionException ex, WebRequest request) {
		System.out.println("ProductsServiceErrorHandler--CommandExecutionException");
		ErrorMessage errorMessage = new ErrorMessage(new Date(), ex.getMessage());
		return new ResponseEntity<>(errorMessage, new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR);
	}
}
